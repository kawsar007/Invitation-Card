...
export default function PricingSection({ theme }) {
  ...
  return (
    <div id="pricing" className={`py-20 ${theme === 'light' ? 'bg-green-50' : 'bg-gray-900'} transition-colors duration-300`}>
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-12">
          <div className={`${theme === 'light' ? 'bg-teal-400' : 'bg-teal-900 text-white'} rounded-full p-1 flex`}>

            <button
              className={`px-6 py-2 rounded-full text-sm transition-all duration-300 ${billingCycle === 'monthly'
                ? theme === 'light'
                  ? 'bg-teal-300 text-gray-900 shadow-md'
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          ...
          <div className={`border rounded-lg p-8 ${theme === 'light' ? 'bg-gray-100' : 'bg-gray-800'} `}>
            ...
            <button className="w-full bg-teal-400 hover:bg-teal-500 text-white py-3 rounded mb-6">
              Get started
            </button>
