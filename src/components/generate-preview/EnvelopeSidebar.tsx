    ...
    <div>
      ...
      <section className="mb-8">
        ...
        <div className="text-center mb-6">
          ...
          {/* <p className="text-gray-400 mb-1 text-sm">Dhaka</p> */}
      ...
      <div className="sticky bottom-0 left-0 right-0 bg-white py-4 border-gray-200">
        <button className="bg-teal-500 text-white w-full py-3 px-8 rounded text-sm font-medium hover:bg-teal-600 transition-colors tracking-wide">
          SUBMIT RSVP
        </button>
      </div>
    </div>
