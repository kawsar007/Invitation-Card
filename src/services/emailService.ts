        ...
        <div style="text-align: center; padding: 32px; background-color: #f9fafb;">
          ...
          <div style="margin-bottom: 24px;">
            ...
            <div style="text-align: center; margin-bottom: 16px;">
              <a href="http://localhost:8080/envelope" style="background-color: #4b5563; color: #ffffff; padding: 8px 24px; border-radius: 4px; text-decoration: none; font-size: 14px; font-weight: 500; display: inline-block;">
                OPEN INVITATION
              </a>
            </div>
          </div>
